    ...
    <div className="p-4 divide-y divide-black">
      ...
      <div className="bg-white grid grid-cols-[5fr_13fr] pt-2">
        ...
        <main className="block isolate min-w-0 ml-2">
          <section className="my-2 border border-black divide-y divide-black">
            <h2 className="font-bold text-xs p-2">New Website</h2>
            <p className="text-xs p-2">
              i chose to redesign my website for the 20th time. i'm not sure why i keep doing this, but i'm happy with the result. i hope you are too.
            </p>
          </section>
        </main>
      </div>
